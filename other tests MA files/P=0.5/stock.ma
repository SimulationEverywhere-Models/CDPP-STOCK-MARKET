...
[stock-rule]
rule : 1 { $changeability := 0; } 10 { $changeability =0 and ( truecount = 2 and round(uniform(0,10000))< 5000) }
rule : 1 { $changeability := 0; } 10 { $changeability =0 and ( truecount = 3 and round(uniform(0,10000))< 7500) }
rule : 1 { $changeability := 0; } 10 { $changeability =0 and ( truecount = 4 and round(uniform(0,10000))< 8750) }
rule : 1 { $changeability := 0; } 10 { $changeability =0 and ( truecount = 5 and round(uniform(0,10000))< 9375) }
